...
// Custom TikTok icon matching LucideIcon signature
const TikTokIcon = forwardRef<SVGSVGElement, SVGProps<SVGSVGElement>>(
  ({ className, ...props }, ref) => (
    <svg
      ref={ref}
      className={className}
...
// OnlyFans icon matching LucideIcon signature
const OnlyFansIcon = forwardRef<SVGSVGElement, SVGProps<SVGSVGElement>>(
  ({ className, ...props }, ref) => (
    <svg
      ref={ref}
      className={className}
...
OnlyFansIcon.displayName = "OnlyFansIcon";

// Privacy icon matching LucideIcon signature
const PrivacyIcon = forwardRef<SVGSVGElement, SVGProps<SVGSVGElement>>(
  ({ className, ...props }, ref) => (
    <svg
      ref={ref}
      className={className}
...
export function SocialLinks({
  ...
  const links = allLinks.filter((link): link is SocialLink & { url: string } => !!link.url);
